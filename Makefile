...
TESTS := test_null test_prepend_null test_count
...
submission.tar: src/list.c src/validate.c
...
# be test_sometest.
test_%: tests/%.o src/list.o src/validate.o
	$(CC) -o $@ $^ $(LDFLAGS)
